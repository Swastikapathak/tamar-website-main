            ...
            {developmentProcess.map((step, index) => (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center h-full">
                  ...
                  <h3 className="text-base sm:text-lg font-light mb-2 text-white group-hover:text-[#4F45E4] transition-colors duration-300 text-center">
                    {step.title}
                  </h3>
            ...
            {benefits.map((benefit) => (
              ...
              >
                ...
                <div className="relative z-10 text-center flex flex-col items-center">
                  ...
                  <h4 className="text-base md:text-lg font-light mb-2 text-white group-hover:text-[#4F45E4] transition-colors duration-300">
                    {benefit.title}
                  </h4>
